...
function changingCountProduct() {
  document.getElementById(
    "basketSubtitle"
  ).textContent = `${countProducts} товаров`;
  document.getElementById(
    "countOfProductsText"
  ).textContent = `Товары, ${countProducts} шт.`;
}
...
function changingPrices() {
  ...
  document.getElementById(
    "countOfProductsNum"
  ).textContent = `${initialPrice} р.`;
  document.getElementById("myDiscontNum").textContent = `${
